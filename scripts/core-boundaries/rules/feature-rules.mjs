...
export const optionalDependencyFeatureOwnerRules = [
  ...
  },
  {
    ...
    dependencies: [
      ...
      { depName: 'async-trait', ownerFeatures: ['mcp', 'remote-connect', 'workspace-search'] },
      ...
      { depName: 'bitfun-services-core', ownerFeatures: ['git', 'mcp', 'workspace-search'] },
      ...
      { depName: 'thiserror', ownerFeatures: ['git', 'workspace-search'] },
