...
export const REVIEW_COMMAND_RE = /^\/(?:review|deepreview)(?:\s+.*)?$/i;
export const DEEP_REVIEW_COMMAND_RE = /^\/(?:review\s+strict|deepreview)(?:\s+.*)?$/i;
export const REVIEW_STRICT_COMMAND_PREFIX_RE = /^\/review\s+strict\b/i;
export const REVIEW_COMMAND_PREFIX_RE = /^\/review\b/i;
export const DEEP_REVIEW_COMPAT_COMMAND_PREFIX_RE = /^\/deepreview\b/i;
