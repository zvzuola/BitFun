...
|---|---|---|
| `agent-runtime` | Agent registry, scheduler, prompt cache, hooks, goals, DeepReview provider-neutral policy/report state, and runtime control contracts | [AGENTS.md](agent-runtime/AGENTS.md) |
